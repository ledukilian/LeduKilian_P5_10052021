...
class PostManager extends Manager {
   ...
   public function findPostAndComments() {
      $sql = "SELECT post.*, comment.id AS comment_id,
               	...
               	'Hidden' AS admin_password,
               	admin.email AS admin_email,
               	admin.role AS admin_role,
               	admin.created_at AS admin_created_at,
               	admin.updated_at AS admin_updated_at,
               	portfolio.catch_phrase AS admin_catch_phrase,
               	portfolio.avatar_url AS admin_avatar_url,
               	portfolio.avatar_alt_url AS admin_avatar_alt_url,
               	portfolio.url_cv AS admin_url_cv
               FROM post
